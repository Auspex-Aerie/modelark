...
def test_complete_a3_writer_matrix_while_live(tmp_path):
    ...
    if hasattr(drive_bootstrap, "reconcile_drive"):
        _refuse_live(
    ...
    if hasattr(register, "register_drive"):
        _refuse_live(
